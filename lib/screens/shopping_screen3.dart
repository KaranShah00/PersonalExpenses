...
//                 AccordionSection(
//                   isOpen: true,
//                   headerBackgroundColor: Colors.deepPurple, //Colors.black38,
//                   headerBackgroundColorOpened: Colors.deepPurple.shade800, //Colors.black54,
//                   flipRightIconIfOpen: true,
//                   header: Row(
//                     children: [
//                       Text(grp.name, style: _headerStyle),
//                       Spacer(),
//                       IconButton(icon: Icon(Icons.add, color: Colors.white,), onPressed: () => _addItem(context, grp.id),),
//                       IconButton(icon: Icon(Icons.edit, color: Colors.white), onPressed: () => _editGroup(grp, context),),
//                       IconButton(icon: Icon(Icons.delete, color: Colors.red,), onPressed: () => p.deleteGroup(grp.id),),
//                     ],
//                   ),
//                   rightIcon: Icon(Icons.arrow_drop_down_outlined, color: Colors.white),
